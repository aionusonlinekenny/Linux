...
Include("\\script\\dailogsys\\dailogsay.lua")
Include("\\script\\missions\\leaguematch\\npc\\officer.lua")
Include("\\script\\global\\vldoxanh\\themnpc.lua")
Include("\\script\\global\\vldoxanh\\trangbitim.lua")

---------------------------------------------------------------------
-------------------------------------------------------------------------------------------
LENHBAI_ADMIN = "<#><link=image[0]:\\spr\\item\\sprADMIN.spr>LÖnh Bµi GM: <link>"
local tbGMAccount = {"kennylucia","kennylucia1","kennylucia2","kennylucia3","kennylucia4","kennylucia5","kennylucia6","kennylucia7","kennylucia8","kennylucia9","kennylucia10","kennylucia11","kennylucia12","kennylucia13","kennylucia14","kennylucia15"}
function main()
...
function nhanKT()
AskClientForNumber("nhanKT",0,1000,"NhËp Sè L­îng:") 
end

function nhanKT(slnhanKT)
for i = 1, 100 do
AddItem(6,1,4868,1,1,0,0,0)
end
end
...
function QLServer()
    ...
    local tbSay = {}
			...
			tinsert(tbSay,"Thªm kiÓm tra NPC/ThemNPC")
...
local tbOpt =
	{
		{"NhËn §å Xanh",laydoxanh},
          {"NhËn §å TÝm MaxOpt",laydotimmenu},
		{"NhËn Ph«i §å TÝm",laydotim},
...
--armor--belt--boot--cuff--helm--
--VK-AddQualityItem(2,0, 0, 1, 1, 1, 0, 30, 230, 130, 480, 140, 110)--
--Mu-AddQualityItem(2,0, 7, 2, 1, 4, 0, 180, 300, 150, 370, 160, 380)--
--Ao-AddQualityItem(2,0, 2, 0, 1, 3, 0, 90, 280, 150, 370, 160, 360)--
--DaiLung-AddQualityItem(2,0, 6, 0, 1, 0, 0, 180, 290, 150, 370, 160, 270)--
--Giay-AddQualityItem(2,0, 5, 0, 1, 2, 0, 70, 310, 150, 370, 160, 340)--
--BaoTay-AddQualityItem(2,0, 8, 1, 1, 3, 0, 180, 280, 150, 370, 160, 360)--
-----LÊy §å TÝm------------------------------------------------
function laydotim()
local szTitle = LENHBAI_ADMIN.."Xin chµo Admin <color=red>"..GetName().."<color>,Nh÷ng chøc n¨ng bªn d­íi cã thÓ gióp b¹n kiÓm tra Server hoÆc hæ trî ng­êi ch¬i.\n\n<pic=137> Online    : <color=green>"..GetPlayerCount().."<color>"
local tbOpt =
...
local tbOpt =
	{
		{"ThÊt B¶o Cµ Sa - ¸o nam", aothieulam},
		{"Ch©n Vò Th¸nh Y - ¸o nam", aovodang},
		{"Thiªn NhÉn MËt Trang - ¸o nam", aothiennhan},
		{"Gi¸ng Sa Bµo - ¸o nam", sabao},
		{"§­êng Nghª Gi¸p - ¸o nam", dng},
		{"V¹n L­u Quy T«ng Y - ¸o nam", aocaibang},
		{"TuyÒn Long Bµo - ¸o nam", longbao},
		{"Long Tiªu §¹o Y - ¸o n÷", daoy},
		{"Cöu VÜ B¹ch Hå Trang - ¸o n÷", hotrang},
		{"TrÇm H­¬ng Sam - ¸o n÷", huongsam},
		{"TÝch LÞch Kim Phông Gi¸p - ¸o n÷", kimphung},
		{"V¹n Chóng TÒ T©m Y  - ¸o n÷", tamy},
		{"L­u Tiªn QuÇn - ¸o n÷", tienquan},
		{"Trë L¹i",TrangBi},
		{"Tho¸t"},
	}
	CreateNewSayEx(szTitle, tbOpt)
