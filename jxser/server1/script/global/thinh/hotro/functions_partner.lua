...
function functions_for_partner()
	...
	local tbOpt =
	{
		"Chän §ång Hµnh/Create_Pet",
		"Xãa §ång Hµnh hiÖn t¹i/Delete_Pet",
        "§æi Ngo¹i H×nh §ång Hµnh/FeaturePet",	
		"§æi Tªn §ång Hµnh/change_name_pet",
		"T¨ng Emotion/IncreaseEmotion",
		"LÊy S¸ch Kh¸ng mçi 12 level(Dïng max 20 quyÓn)/HoiLV",
...
local tbOpt =
	{
		"TiÓu ®ång/#DoiHinhPet(1)",
		"ThiÕu niªn/#DoiHinhPet(2)",
		"Thµnh niªn/#DoiHinhPet(3)",
		"Trë l¹i/Pet",
		"Tho¸t./no",
	}
	Say(szTitle, getn(tbOpt), tbOpt)
...
local tbOpt =
	{
		{"Häc skill Thêi Gian Phôc Håi", learn_skill_special},
		...
		{"S¸ch T¨ng Sinh Lùc",SachSpecial,{868}},
...
function Create_Pet()
local szTitle = "B¹n muèn nhËn §ång Hµnh nµo?"
local tbOpt =
	{
		{"TuyÕt Nhi - HÖ Kim",Pet_Create, {0}},
		{"B¹ch Nhi - HÖ Méc",Pet_Create, {1}},
		{"LËn V©n Mi - HÖ Thñy",Pet_Create, {2}},
		{"Phô Dung - HÖ Háa",Pet_Create, {3}},
		{"TiÓu Viªn Tö - HÖ Thæ",Pet_Create, {4}},
		{"Trë l¹i", Pet},
		{"Tho¸t."},
	}
	CreateNewSayEx(szTitle, tbOpt)
...
function Pet_Create(nSeries)
	...
	Msg2Player("Pet ID "..5-nSeries.." - "..nSeries)
