...
tbChat = 
{
	...
	"<color=orange>Lªn Trang Chñ <color=red>www.vldoxanh.com<color> ®Ó nhËn gift code"
}
...
npcchat_npcmacdinh()
local szTitle = "<npc> Xin chµo <color=red>"..GetName().."<color> ! Vµo trang chñ: <color=yellow>www.vldoxanh.com<color> ®Ó nhËn gift code. \n\n<color=green>Chó ý b¶o vÖ søc kháe vµ tµi s¶n khi ch¬i Game.<pic=115><color>"
tbOpt=
{
	{"NhËn Quµ SERVER", Code},
	{"Th«i"},
}
