...
------------------------------------------------------------------------------------------------------------
function main()
dofile("script/global/pgaming/npccongfullskill.lua")
dialog_main()
end
tbChat = 
{
	"<color=green>Chµo mõng quý nh©n sü <pic=1>",
	"<color=green>Ai CÇn Céng Skill Tíi ®©y",
	"<color=orange>Chóc ®¹i hiÖp ch¬i game vui vÎ, nhí like, share trang chñ vldoxanh.com nha!"
}
...
tbOpt=
{
	{"Hæ Trî C«ng Full Skill", HoTroTanThu},
	{"Th«i"},
}
...
function dialog_main()
npcchat_npcmacdinh()
local szTitle = "<npc> Xin chµo <color=red>"..GetName().."<color> ! Chµo mõng ®Õn víi <color=yellow>Vâ L©m TruyÒn Kú Online<color>. \n\n<color=green>Chó ý b¶o vÖ søc kháe vµ tµi s¶n khi ch¬i Game.<pic=115><color>"
