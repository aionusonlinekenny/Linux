...
tbitem1  =
	{
		...
		[3]	={szName = "T©n thñ lÔ bao cÊp 10", tbProp = {6, 1, 4259,1,0,0}, nCount = 1, nExpiredTime = 10080, nBindState = -2},
	}
tbitem10  =
	{
...
tbitem30  =
	{
		...
		[2]	={szName = "Tiªn th¶o lé", tbProp = {6, 1, 71, 1,0,0}, nCount = 1, nExpiredTime = 10080, nBindState = -2},
		[3]	={szName = "T©n thñ lÔ bao cÊp 40", tbProp = {6, 1, 4262,1,0,0}, nCount = 1, nExpiredTime = 10080, nBindState = -2},
	}
tbitem40  =
	{
		[1]	={szName = "Håi thiªn t¸i t¹o lÔ bao", tbProp = {6, 1, 2527, 1,0,0}, nCount = 1, nExpiredTime = 10080, nBindState = -2},
...
function main(nItemIndex)
	dofile("script/global/pgaming/hotrotanthu/tanthuitem.lua");	
