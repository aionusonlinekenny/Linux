...
Include("\\script\\global\\vldoxanh\\cauca\\head.lua")
IncludeLib("ITEM")
Include("\\script\\missions\\leaguematch\\npc\\officer.lua")
MAXCOUNT = 5
local ItemAward = {
	{szName="C¸ sÊu",tbProp={6,1,4802,1,0,0},nCount=2,nRate=45},
	{szName="Mùc",tbProp={6,1,4803,1,0,0},nCount=2,nRate=35},
	{szName="T«m",tbProp={6,1,4804,1,0,0},nCount=2,nRate=30},	
	{szName="C¸ sÊu",tbProp={6,1,4802,1,0,0},nCount=2,nRate=25},
	
	{szName="C¸ sÊu",tbProp={6,1,4802,1,0,0},nCount=3,nRate=20},
	{szName="C¸ sÊu",tbProp={6,1,4802,1,0,0},nCount=4,nRate=15},
	
	{szName="Mùc",tbProp={6,1,4803,1,0,0},nCount=3,nRate=15},
	{szName="Mùc",tbProp={6,1,4803,1,0,0},nCount=4,nRate=10},
	
	{szName="T«m",tbProp={6,1,4804,1,0,0},nCount=3,nRate=10},
	{szName="T«m",tbProp={6,1,4804,1,0,0},nCount=4,nRate=5},	

	{szName="Nµng tiªn c¸",tbProp={6,1,4805,1,0,0},nCount=1,nRate=7},
	{szName="Nµng tiªn c¸",tbProp={6,1,4805,1,0,0},nCount=2,nRate=5},
