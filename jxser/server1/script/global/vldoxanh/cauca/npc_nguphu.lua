...
tbChat = 
{
	"<color=green>C¸c ®¹i hiÖp cÇn mua dông cô b¾t c¸ th× h·y ghÐ qua hµng ta <pic=1>",
	"<color=green>T¹i ®©y ta cã b¸n c¸c lo¹i cÇn c©u vµ l­íi b¾t c¸.",
	"<color=orange>Chóc ®¹i hiÖp ch¬i game vui vÎ nha!"
}
