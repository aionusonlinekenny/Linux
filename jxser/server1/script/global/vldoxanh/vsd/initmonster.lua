...
function OnTimer(nNpcIndex,nTimeOut)
	local tab_Chat = {
		"<color=green>Chµo quý quý nh©n sü ®· ®Õn víi <color=red>Vâ L©m Online  VLDOXANH<color>.",
		"<color=green>§éi ngò kü thuËt cã kinh nghiÖm trong viÖc vËn hµnh Game.",
		"<color=green><color=red>Vâ L©m Online VLDOXANH<color> n¬i høa hÑn ®em ®Õn 1 s©n ch¬i cùc kú hÊp dÉn",
		...
		"<color=green>H·y Share  VLDOXANH ®Ó cã thÓ giíi thiÖu ®Õn mäi ng­êi.",
		"<color=green>Chóng ta h·y chung tay v× 1 céng ®ång Game Vâ L©m Online v÷ng m¹nh.",
	}
	...
	SetNpcScript(nNpcIndex,"\\script\\global\\vldoxanh\\vsd\\initmonster.lua")
end
...
function Add_Npc_Hello()
	...
	for i=1,getn(tb_npc_hello) do
		--for j=1,5 do
			...
			SetNpcScript(npcdialog,"\\script\\global\\vldoxanh\\vsd\\initmonster.lua")
		--end
	end
end