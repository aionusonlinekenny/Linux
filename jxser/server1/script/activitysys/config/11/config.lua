...
tbConfig[2] = --Ò»¸öÏ¸½Ú
{
	...
	tbCondition = 
	{
		...
		{"lib:CheckDay",	{20240402, 20240501, szOUT_OF_DATE} },
	},
	tbActition = 
	{
...
tbConfig[4] = --Ò»¸öÏ¸½Ú
{
	...
	tbCondition = 
	{
		...
		{"PlayerFunLib:CheckFreeBagCell",	{1,"Hµnh trang kh«ng ®ñ chç trèng"} },
		{"lib:CheckDay",	{20240402, 20240502, szOUT_OF_DATE} },
	},
	tbActition = 
	{
...
tbConfig[15] = --Ò»¸öÏ¸½Ú
{
	...
	tbCondition = 
	{
		{"PlayerFunLib:CheckTotalLevel",	{100,"default",">="} },
...
tbConfig[17] = --Ò»¸öÏ¸½Ú
{
	...
	tbCondition = 
	{
		...
		{"AddOneMaterial",	{"A'o LÝnh BÞ R¸ch",tbITEM_TATTERED_UNIFORM,5} },
