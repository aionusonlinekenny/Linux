...
times = GetTask(701) 
str ={ 
"<#> Ng­¬i thö c¾n 1 c¸i Cèng NguyÖt Phï Dung , kÕt qu¶ c¸i g× còng kh«ng cã ph¸t sinh. :(", 
"<#> Ng­¬i ¨n råi 1 Cèng NguyÖt Phï Dung , c¶m thÊy thÓ tr¹ng nhÑ kú tho¸t tôc , kinh m¹ch chËm h¬i thë thuËn s­íng. ", 
"<#> Ng­¬i ®· ¨n 3 c¸i Cèng NguyÖt Phï Dung råi , b©y giê kh«ng ¨n ®­îc n÷a. " 
} 
level = GetLevel() 
...
time=date("%m%d%H%M%S") 
name=GetName() 
WriteLog("Ng­êi ch¬i "..name.." ë "..time.." ¨n hÕt 1 c¸i Cèng NguyÖt Phï Dung råi.") 
	SetTask(701,times+1)
Msg2Player(str[2]) 
return 0 
end
