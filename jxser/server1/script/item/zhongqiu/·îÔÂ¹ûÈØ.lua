...
times = GetTask(700) 
str={ 
"<#> Ng­¬i thö c¾n 1 c¸i Phông NguyÖt Qu¶ Dung , kÕt qu¶ c¸i g× còng kh«ng cã ph¸t sinh . :(", 
"<#> Ng­¬i thö c¾n 1 c¸i Phông NguyÖt Qu¶ Dung , kÕt qu¶ kh«ng cã ph¸t hiÖn vâ c«ng cã c¸i g× râ rµng biÕn hãa . ", 
"<#> Ng­¬i ¨n 1 Phông NguyÖt Qu¶ Dung , c¶m thÊy trong c¬ thÓ cã mét cæ ch©n khİ l­u ®éng , nhÊt thêi vâ c«ng tinh tiÕn . ", 
"<#> Ng­¬i ®· ¨n 2 c¸i Phông NguyÖt Qu¶ Dung råi , b©y giê kh«ng ¨n ®­îc n÷a. " 
} 
...
time=date("%m%d%H%M%S") 
name=GetName() 
WriteLog("Ng­êi ch¬i "..name.." ë "..time.." ¨n hÕt 1 Phông NguyÖt Qu¶ Dung ") 
		SetTask(700,times+1)
Msg2Player(str[3]) 
return 0 
end 
