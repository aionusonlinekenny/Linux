...
function TaskContent()
	...
	if nDate < 080611 or nDate > 120713 then --¥”2008ƒÍ06‘¬11∫≈ ÷¡®C 2008ƒÍ07‘¬13∫≈24µ„
		return
	end
	local bIsStart = 0
	...
	if bIsStart == 1 then
		...
		GlobalExecute(format("dw AddLocalCountNews([[%s]], 2)", "Hoπt ÆÈng 4 mÔa tranh tµi Æ∑ bæt Æ«u b∏o danh, tr≠Ìc mæt c„ th” Æ’n Minh Nguy÷t Tr n Æ” b∏o danh, 1 phÛt sau tranh tµi bæt Æ«u."))
	end
end
