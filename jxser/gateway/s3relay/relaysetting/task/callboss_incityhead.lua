...
["ChiÕn Long §éng"] =    {{959, {{1659,3095},{1705,3044},{1505,3104},{1622,3046},{1619,2954}}, "ChiÕn Long §éng"   },},
["Ba L¨ng HuyÖn"] =    {{53, {{1672,3262}}, "Ba L¨ng HuyÖn"   },},
["Th«n Ba L¨ng HuyÖn"] =    {{53, {{1547,3270}}, "Th«n Ba L¨ng HuyÖn"   },},
}
...
function qy_makeboss_onlyone_pos()
	for i = 1, getn(QY_GOLDBOSS_APOS_INFO) do
		...
		OutputMsg("KHOI TAO BOSS "..bossname..","..bossid..","..bosslvl..","..world..","..posx..","..posy..","..series..date("----%Y%m%d%H%M"))
	end
end
...
function qy_makeboss_lotsof_pos()
	for i = 1, getn(QY_GOLDBOSS_DPOS_INFO) do
		...
		OutputMsg("KHOI TAO BOSS "..bossname..","..bossid..","..bosslvl..","..series..date("----%Y%m%d%H%M"))
	end
end
