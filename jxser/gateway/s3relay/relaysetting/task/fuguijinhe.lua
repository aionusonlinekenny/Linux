...
function TaskShedule()
	...
	TaskCountLimit(0)
	OutputMsg("=================HOAT DONG PHU QUY CAM HAP============== ");
end
...
--	end
	...
	if (220000 <= nTime and nTime < 230000) then
		...
		local szLog = "[KHOI TAO DAY SO MAY MAN] ";
		...
		local szMsg = format("C«ng bè con sè may m¾n ®ît nµy ! %s  Sè ®Æc biÖt : <color=green>%s<color>", szNormalNumInfo, szSpecNumInfo)
