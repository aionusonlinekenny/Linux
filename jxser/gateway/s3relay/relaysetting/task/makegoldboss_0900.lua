...
--					{"Thanh TuyÖt S­ Th¸i", 743, 95, 341, 2, "giang hå truyÒn thanh tuyÖt s­ th¸i ®· tõng danh chÊn giang hå, xuÊt hiÖn ë M¹c B¾c th¶o nguyªn, giang hæ ®ang cã mét cuéc huyÕt chiÕn!", "\\settings\\maps\\¶«±±Çø\\Ä®±±²UÔ­\\qingxiaoshitaiboss.txt"},
...
--					{"Hµ Nh©n Ng·", 745, 95, 321, 3, "giang hå t­¬ng truyÒn, ng­êi nµo ta ®· xuÊt hiÖn ë Tr­êng b¸ch s¬n, giang hæ ®ang cã mét cuéc huyÕt chiÕn!", "\\settings\\maps\\¶«±±Çø\\³¤°×É½Â´\\xuanjiziboss.txt"},
...
function TaskShedule()
	-- ÉèÖÃ·½°¸Ãû³Æ
	TaskName( "BOSS HOANG KIM XUAT HIEN VAO 09:00" );
	TaskInterval( 1440 );
	TaskTime( 9, 0 );
	TaskCountLimit( 0 );
	-- Êä³öÆô¶¯ÏûÏ¢
	OutputMsg("BOSS HOANG KIM MON PHAI at 09:00");
end
