TIME_HOUR = "5";--gio bat dau danh
TIME_MIN = "30";-- phut bat dau
--(Tuc la 9h00 sang bat dau danh)
...
TaskInterval(1440);
TaskCountLimit( 0 );
OutputMsg( "=================Phuc-Loc-Tho Start 00h Sang Den 23h00 Toi=================" );
end
...
function TaskContent()
 ...
 local strExecute = format( "dw BauCuaKhoiDong()");
	...
	OutputMsg("=====> Phuc-Loc-Tho Start -- 0:00AM-- end ------23:59PM-------------- ");
end
