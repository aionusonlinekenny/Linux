...
function TaskShedule()
	...
	OutputMsg(format("HOAT DONG TIM THIEU NU GIANG SINH LA %s:%s...",nstarth,nmin))
	TaskCountLimit(0);
end
...
function TaskContent()
	...
	local szMsg = format("[T×m kiÕm ThiÕu N÷ ThÇn Bİ] Gi¸ng sinh thiÕu n÷ B¹ch Nhi, §«ng Nhi, TuyÕt Nhi ®· xuÊt hiÖn. Nhanh ®Õn B¨ng Nhi ®Ó ghi danh.")
	GlobalExecute(format("dw AddLocalNews([[%s]])", szMsg))
	OutputMsg("HOAT DONG TIM THIEU NU GIANG SINH BAT DAU")
end
